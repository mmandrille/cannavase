"""
Django settings for cannavase project.
...
SECRET_KEY = 'uvevaw#vhlr0qh_i%e6jd9(yw+cdeztr=fwwe@&h&xfz7fej8m'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'cannava.com.ar',]
...
WSGI_APPLICATION = 'cannavase.wsgi.application'
